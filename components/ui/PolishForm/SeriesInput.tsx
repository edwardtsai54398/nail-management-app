...
const SeriesInput = forwardRef<PolishColumnRef<string>, SeriesInputProps>(({val, brandId}, ref) => {
    ...
    useImperativeHandle(ref, () => ({
        getValue: () => seriesId,
        setValue: (val) => {setSeriesId(val)}
    }))
    return (<DetailInput label="系列" type="select" border="bottom" value={seriesName} onSelectPress={handlePress} />)
})
